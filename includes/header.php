...
<link rel="stylesheet" href="/php1/assets/css/style.css">
</head>
<body>
...
<header class="main-header">
    <div class="header-container">
        ...
        <nav class="main-nav">
            <a href="/php1/index.php">الرئيسية</a>
            <a href="/php1/products.php">المنتجات</a>
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <?php if ($_SESSION['role'] === 'admin'): ?>
                    <a href="/php1/cart.php">جميع الطلبات</a>
                    <a href="/php1/admin/addpro.php">إضافة منتج</a>
                    <a href="/php1/admin/admin.php">لوحة الإدارة</a>
                    <?php else: ?>
                    <a href="/php1/cart.php">سلتي (<span class="cart-count"><?= isset($_SESSION['cart']) ? array_sum(array_column($_SESSION['cart'], 'qty')) : 0; ?></span>)</a>
                <?php endif; ?>
                <a href="/php1/profile.php">الملف الشخصي</a>
                <a href="/php1/logout.php" data-no-pjax>تسجيل الخروج (<?= htmlspecialchars($_SESSION['username']); ?>)</a>
            <?php else: ?>
                <a href="/php1/login.php" data-no-pjax>تسجيل الدخول</a>
                <a href="/php1/register.php" data-no-pjax>التسجيل</a>
            <?php endif; ?>
